...
export const defaultPortfolio: PortfolioContent = {
  owner: {
    ...
    status: i18n("", ""),
    intro: i18n(
      "I build Roblox environments and Luau systems with a focus on clarity, atmosphere and polished execution.",
      "Crio ambientes no Roblox e sistemas em Luau com foco em clareza, atmosfera e execução bem acabada."
    ),
